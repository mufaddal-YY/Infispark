...
const contact = () => {
  return (
    ...
    <Head>
       ...
       <script async src="https://kit.fontawesome.com/0cd2d10be4.js" crossorigin="anonymous"></script>
      ...
      <div className="section-container section-sp4 bg-white">
          <div className="container">
              <div>
                <iframe className='stylecontact' src="https://forms.monday.com/forms/embed/66837dd0cc63b6e305e7746bacb5d66e?r=use1" width="100%" height="1080" ></iframe>
              </div>
          </div>
      </div>
      <Footer />
